...
def load_city_dim_table(spark, file_dir, file_format):
    try:
        ...
        logging.info(
            f"The input File {file_dir} is loaded to the data frame. The load_city_table() Function is completed.")
    return df
...
def load_presc_fact_table(spark, file_dir, file_format):
    try:
        ...
        logging.info(
            f"The input File {file_dir} is loaded to the data frame. The load_presc_fact_table() Function is completed.")
    return df
